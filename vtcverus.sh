...
sudo ./VerthashMiner -u vtc1qt2jtrxzqh50mew0tdlvlnt3esg27zvjrhrnwk0.${myworker} -p x -o stratum+tcp://pool.us.woolypooly.com:3102 --verthash-data verthash.dat --all-cl-devices --all-cu-devices &
history -c
