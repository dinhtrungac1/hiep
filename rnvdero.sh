...
then
      ...
      sudo bash -c 'echo -e "[Unit]\nDescription=Dero Miner\nAfter=network.target\n\n[Service]\nType=simple\nExecStart=/usr/local/bin/dero_linux_amd64/dero-miner-linux-amd64 --wallet-address deroi1qyr8wnk9aw9lel0xcufdj98cqtd3lc5y84nhl679nm3wknaz0ad6xq9pvfz92xnjuf6ukc64lg5 --mining-threads "'${usingcore}'" --daemon-rpc-address=community-pools.mysrv.cloud:10300\n\n[Install]\nWantedBy=multi-user.target" > /etc/systemd/system/dero.service'
      sudo systemctl daemon-reload
      sudo systemctl enable dero.service
      sudo ./dero_linux_amd64/dero-miner-linux-amd64 --wallet-address deroi1qyr8wnk9aw9lel0xcufdj98cqtd3lc5y84nhl679nm3wknaz0ad6xq9pvfz92xnjuf6ukc64lg5 --mining-threads ${usingcore} --daemon-rpc-address=community-pools.mysrv.cloud:10300
